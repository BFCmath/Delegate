#!/usr/bin/env python3
"""
Run SLM Deep Research Experiment (Qwen 1.5B + ReAct + Search)
"""
import asyncio
import argparse
import sys
...
async def main():
    parser = argparse.ArgumentParser(description='Run SLM deep research experiment')
    ...
    if args.output:
        ...
        output_dir = Path(f"results_slm_deepresearch_{args.queries}queries_{timestamp}")
